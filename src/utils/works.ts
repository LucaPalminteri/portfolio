...
const works: Work[] = [
    ...
    {
        title: "Restaurant Administration Website (Side Project)",
    ...
    {
        title: "Data Insights Corp",
        position: "Frontend Developer",
        duration: "2020 - 2021",
        description: `
          Served as a Frontend Developer at Data Insights Corp.
          Played a key role in redesigning the user interface of the company's analytics dashboard, improving overall user engagement.
          Integrated data visualization libraries to present complex information in an easily understandable format.
          Worked closely with UX/UI designers to implement responsive design principles for a seamless user experience.
        `,
    },
    {
        title: "E-Commerce Solutions LLC",
        position: "Full Stack Developer",
        duration: "2019 - 2020",
        description: `
          Worked as a Full Stack Developer at E-Commerce Solutions LLC.
          Led the development of a custom e-commerce platform, incorporating secure payment gateways and order processing functionalities.
          Implemented authentication and authorization mechanisms to ensure data security and user privacy.
          Collaborated with cross-functional teams to troubleshoot and resolve issues, contributing to a robust and reliable platform.
        `,
    },
];
